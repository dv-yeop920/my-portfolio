...
export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      status: "운영 중",
      summary:
        "2~15명의 MBTI와 관계 유형을 바탕으로 그룹의 분위기와 역할 그리고 1:1 케미를 AI 리포트로 보여주는 웹 서비스입니다.",
      purpose:
      ...
      architectureDescription:
        "사용자 입력은 Next.js 서버를 거쳐 OpenAI로 전달하고, 결과를 검증한 뒤 로그인 결과는 Supabase에 저장하며 게스트 결과는 임시로 보관합니다. API Key와 Prompt는 브라우저에 노출하지 않고 서버에서 관리합니다.",
