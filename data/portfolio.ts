...
export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      retrospective:
        "MIXTI를 만들며 외부 API는 요청을 보내고 결과를 보여주는 것만으로 끝나지 않는다는 점을 배웠습니다. 입력과 결과를 검증하고 오류를 나눠야 사용자가 믿고 볼 수 있는 결과가 됐습니다.\n\nAI를 개발 과정에도 활용하면서 조사 → 계획 → 구현 → 리뷰의 흐름을 만들었고, 배포 후에는 GA4와 Vercel Speed Insights로 사용자 흐름과 성능을 확인하고 있습니다.",
